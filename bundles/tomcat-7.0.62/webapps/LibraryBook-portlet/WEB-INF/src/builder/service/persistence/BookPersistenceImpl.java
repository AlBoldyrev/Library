...
import builder.NoSuchBookException;

import builder.model.Book;

import builder.model.impl.BookImpl;
import builder.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	...
	@Override
	public Book updateImpl(builder.model.Book book) throws SystemException {
		book = toUnwrappedModel(book);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.builder.model.Book")));
