...
import builder.NoSuchAuthorException;

import builder.model.Author;

import builder.model.impl.AuthorImpl;
import builder.model.impl.AuthorModelImpl;
...
public class AuthorPersistenceImpl extends BasePersistenceImpl<Author>
	...
	@Override
	public Author updateImpl(builder.model.Author author)
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.builder.model.Author")));
