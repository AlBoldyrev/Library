...
/**
 * Provides the local service interface for Table. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sasha
 * @see TableLocalServiceUtil
...
public interface TableLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TableLocalServiceUtil} to access the table local service. Add custom service methods to {@link builder.service.impl.TableLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
