...
import builder.model.AuthorClp;
import builder.model.BookClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"LibraryBook-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "LibraryBook-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("builder.model.impl.AuthorImpl")) {
		...
		if (oldModelClassName.equals("builder.model.impl.BookImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("builder.NoSuchAuthorException")) {
			return new builder.NoSuchAuthorException();
		}

		if (className.equals("builder.NoSuchBookException")) {
			return new builder.NoSuchBookException();
		}
