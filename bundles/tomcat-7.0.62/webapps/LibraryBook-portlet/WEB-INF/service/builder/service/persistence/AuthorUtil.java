...
public class AuthorUtil {
	...
	*/
	public static void cacheResult(builder.model.Author author) {
	...
	*/
	public static void cacheResult(java.util.List<builder.model.Author> authors) {
	...
	*/
	public static builder.model.Author create(long authorId) {
	...
	* @throws builder.NoSuchAuthorException if a author with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static builder.model.Author remove(long authorId)
		throws builder.NoSuchAuthorException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(authorId);
	}

	public static builder.model.Author updateImpl(builder.model.Author author)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(author);
	}

	/**
	* Returns the author with the primary key or throws a {@link builder.NoSuchAuthorException} if it could not be found.
	*
	* @param authorId the primary key of the author
	* @return the author
	* @throws builder.NoSuchAuthorException if a author with the primary key could not be found
	* @throws SystemException if a system exception occurred
	*/
	public static builder.model.Author findByPrimaryKey(long authorId)
		throws builder.NoSuchAuthorException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static builder.model.Author fetchByPrimaryKey(long authorId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<builder.model.Author> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<builder.model.Author> findAll(int start,
	...
	*/
	...
	public static AuthorPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (AuthorPersistence)PortletBeanLocatorUtil.locate(builder.service.ClpSerializer.getServletContextName(),
