...
<%@page import="com.softwerke.services.service.AuthorLocalServiceUtil"%>
...
<portlet:renderURL var="addBookVar">
	<portlet:param name="pageName" value="<%=BookAndAuthorOperations.ADD_BOOK %>"/>
</portlet:renderURL>

<portlet:renderURL var="addAuthorVar">
	<portlet:param name="pageName" value="<%=BookAndAuthorOperations.ADD_AUTHOR %>"/>
</portlet:renderURL>
...
<liferay-ui:search-container>
    ...
    <liferay-ui:search-container-row className="com.softwerke.BookModel" keyProperty= "bookId" modelVar="aBook">
       	<liferay-ui:search-container-column-text property="bookId" name="Book Id" />
