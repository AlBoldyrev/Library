...
package com.softwerke.services.service.persistence;
...
import com.softwerke.services.NoSuchBookException;
import com.softwerke.services.model.Book;
import com.softwerke.services.model.impl.BookImpl;
import com.softwerke.services.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	 ...
	 */
	@Override
	public List<Book> findByAuthor(long authorId) throws SystemException {
	 ...
	 */
	@Override
	public List<Book> findByAuthor(long authorId, int start, int end)
	 ...
	 * @throws com.softwerke.services.NoSuchBookException if a matching book could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public Book findByAuthor_First(long authorId,
		OrderByComparator orderByComparator)
		throws NoSuchBookException, SystemException {
		Book book = fetchByAuthor_First(authorId, orderByComparator);
	 ...
	 */
	@Override
	public Book fetchByAuthor_First(long authorId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Book> list = findByAuthor(authorId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Book findByAuthor_Last(long authorId,
		OrderByComparator orderByComparator)
		throws NoSuchBookException, SystemException {
		Book book = fetchByAuthor_Last(authorId, orderByComparator);
	 ...
	 */
	@Override
	public Book fetchByAuthor_Last(long authorId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Book> list = findByAuthor(authorId, count - 1, count,
				orderByComparator);
	 ...
	 * @throws com.softwerke.services.NoSuchBookException if a book with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public Book[] findByAuthor_PrevAndNext(long bookId, long authorId,
		OrderByComparator orderByComparator)
		throws NoSuchBookException, SystemException {
		...
		try {
			...
			array[0] = getByAuthor_PrevAndNext(session, book, authorId,
					orderByComparator, true);

			array[1] = book;

			array[2] = getByAuthor_PrevAndNext(session, book, authorId,
	...
	public void removeByAuthor(long authorId) throws SystemException {
		for (Book book : findByAuthor(authorId, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_AUTHOR_AUTHORID_2 = "book.authorId = ?";
	...
	@Override
	public Book updateImpl(com.softwerke.services.model.Book book)
		throws SystemException {
		book = toUnwrappedModel(book);
		...
		if (isNew || !BookModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((bookModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { bookModelImpl.getOriginalAuthorId() };
				...
				args = new Object[] { bookModelImpl.getAuthorId() };
	...
	/**
	 * Returns the book with the primary key or throws a {@link com.softwerke.services.NoSuchBookException} if it could not be found.
	 *
	 * @param bookId the primary key of the book
	 * @return the book
	 * @throws com.softwerke.services.NoSuchBookException if a book with the primary key could not be found
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.softwerke.services.model.Book")));
