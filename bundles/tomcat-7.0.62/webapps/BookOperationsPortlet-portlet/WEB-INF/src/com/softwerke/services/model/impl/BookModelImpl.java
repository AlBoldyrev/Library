...
import com.softwerke.services.model.BookModel;
import com.softwerke.services.model.BookSoap;
...
/**
 * The base model implementation for the Book service. Represents a row in the &quot;bookandauthoroperations_Book&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.softwerke.services.model.BookModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link BookImpl}.
 * </p>
 *
 * @author Sasha
 * @see BookImpl
 * @see com.softwerke.services.model.Book
 * @see com.softwerke.services.model.BookModel
 * @generated
 */
@JSON(strict = true)
public class BookModelImpl extends BaseModelImpl<Book> implements BookModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a book model instance should use the {@link com.softwerke.services.model.Book} interface instead.
	 */
	public static final String TABLE_NAME = "bookandauthoroperations_Book";
	...
	public static final String TABLE_SQL_CREATE = "create table bookandauthoroperations_Book (bookId LONG not null primary key,bookName VARCHAR(75) null,bookDescription VARCHAR(75) null,authorId LONG)";
	public static final String TABLE_SQL_DROP = "drop table bookandauthoroperations_Book";
	public static final String ORDER_BY_JPQL = " ORDER BY book.bookId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY bookandauthoroperations_Book.bookId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.softwerke.services.model.Book"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.softwerke.services.model.Book"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.softwerke.services.model.Book"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.softwerke.services.model.Book"));
