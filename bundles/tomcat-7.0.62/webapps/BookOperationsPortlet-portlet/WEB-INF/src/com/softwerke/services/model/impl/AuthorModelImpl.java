...
import com.softwerke.services.model.AuthorModel;
import com.softwerke.services.model.AuthorSoap;
...
/**
 * The base model implementation for the Author service. Represents a row in the &quot;bookandauthoroperations_Author&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.softwerke.services.model.AuthorModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AuthorImpl}.
 * </p>
 *
 * @author Sasha
 * @see AuthorImpl
 * @see com.softwerke.services.model.Author
 * @see com.softwerke.services.model.AuthorModel
 * @generated
 */
@JSON(strict = true)
public class AuthorModelImpl extends BaseModelImpl<Author>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a author model instance should use the {@link com.softwerke.services.model.Author} interface instead.
	 */
	public static final String TABLE_NAME = "bookandauthoroperations_Author";
	public static final Object[][] TABLE_COLUMNS = {
			{ "authorId", Types.BIGINT },
			{ "authorName", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table bookandauthoroperations_Author (authorId LONG not null primary key,authorName VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table bookandauthoroperations_Author";
	public static final String ORDER_BY_JPQL = " ORDER BY author.authorId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY bookandauthoroperations_Author.authorId ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.softwerke.services.model.Author"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.softwerke.services.model.Author"),
			false);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.softwerke.services.model.Author"));
