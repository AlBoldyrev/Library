...
public class BookWrapper implements Book, ModelWrapper<Book> {
	...
	*/
	...
	@Override
	public int compareTo(com.softwerke.services.model.Book book) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.softwerke.services.model.Book> toCacheModel() {
		return _book.toCacheModel();
	}

	@Override
	public com.softwerke.services.model.Book toEscapedModel() {
		return new BookWrapper(_book.toEscapedModel());
	}

	@Override
	public com.softwerke.services.model.Book toUnescapedModel() {
