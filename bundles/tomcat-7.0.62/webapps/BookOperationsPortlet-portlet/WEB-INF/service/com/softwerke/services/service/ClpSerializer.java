...
import com.softwerke.services.model.AuthorClp;
import com.softwerke.services.model.BookClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"BookOperationsPortlet-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "BookOperationsPortlet-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.softwerke.services.model.impl.AuthorImpl")) {
		...
		if (oldModelClassName.equals(
					"com.softwerke.services.model.impl.BookImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.softwerke.services.NoSuchAuthorException")) {
			return new com.softwerke.services.NoSuchAuthorException();
		}

		if (className.equals("com.softwerke.services.NoSuchBookException")) {
			return new com.softwerke.services.NoSuchBookException();
		}
